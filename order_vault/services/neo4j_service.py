...
def create_graph(tx, G):
    ...
    for u, v in G.edges():
        ...
        if ut == 'customer' and vt == 'order':
            ...
            # --- Step 3: Create direct customer-to-customer relationships by shared attribute X ---
    # For each attribute node in this order, link all other customers sharing that attribute
    for node_id, data in G.nodes(data=True):
